    ...
    return(   
        <div className="about-resume-section">
            <div className="about-section">
                <div className="about-me-img-box"><img className="my-avatar" alt="My Avatar" src={require('../../assets/me.svg')}/></div>
            ...
            <div className="resume-section">
                <a href={require('../../assets/Akhilesh_Jain.pdf')} target='_blank' rel="noopener noreferrer">
